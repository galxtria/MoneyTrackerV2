...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'MoneyTracker - Catat Pengeluaran',
        short_name: 'MoneyTracker',
        description: 'Catat pengeluaran harian offline, hemat untuk mahasiswa.',
        theme_color: '#2563eb',
      ...
      workbox: {
        ...
        // Offline-first: app shell selalu bisa dibuka tanpa internet
        runtimeCaching: [
          {
